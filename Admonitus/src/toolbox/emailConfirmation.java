...
public class emailConfirmation {
	...
	public void sendEmail() {
		...
		try {
			...
			message.setContent("<body font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;> <h2> Confirmation Message </h2> <br><hr> <center>" + action + "</center><hr><p>Best Regards</p><p>Admonitus Team</p></body>", "text/html");
